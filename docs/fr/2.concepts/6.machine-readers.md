...
| `<page>.md`      | Le source Markdown de n’importe quelle page                                |
...
La convention de [llmstxt.org](https://llmstxt.org) en nomme deux, et ils
répondent à des questions différentes : un modèle qui a lu l’index doit encore
récupérer soixante pages, tandis qu’un modèle à qui l’on remet le fichier
complet les a déjà lues. Lequel revient le moins cher dépend de la question : le
site publie donc les deux.
