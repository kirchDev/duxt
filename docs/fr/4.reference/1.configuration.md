...
| `headline`    | une ligne de texte            | Le `h1` ; à défaut, `title`                          |
| `description` | une ligne de texte            | Le paragraphe en dessous, et la meta description de la page |
...
| `features`    | six                           | La grille de cartes                                  |
