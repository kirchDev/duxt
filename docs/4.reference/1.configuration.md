...
| `headline`    | a line of text       | The `h1`; falls back to `title`                     |
| `description` | a line of text       | The paragraph under it, and the page's meta description |
...
call; repeating them under six cards asks a reader who has just arrived to decide
twice.
