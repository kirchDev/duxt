...
| `headline`    | eine Zeile Text          | Die `h1`; fällt auf `title` zurück               |
| `description` | eine Zeile Text          | Der Absatz darunter und die Meta-Beschreibung der Seite |
...
| `features`    | sechs                    | Das Kartenraster                                 |
