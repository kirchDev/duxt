...
Die Konvention von [llmstxt.org](https://llmstxt.org) benennt zwei, und sie
beantworten verschiedene Fragen: Ein Modell, das den Index gelesen hat, muss
immer noch sechzig Seiten abrufen, und ein Modell, dem man die vollständige
Datei gibt, hat sie bereits gelesen. Welche billiger ist, hängt von der Frage
ab — die Seite veröffentlicht deshalb beide.
