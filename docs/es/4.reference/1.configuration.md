...
| :----------------- | :------------------- | :------------------------------------------------------- |
| `title`            | `'duxt'`             | El nombre en la barra de navegación y en el título SEO    |
| `version`          | `'v0.0.0'`           | El distintivo junto a él                                  |
...
| Clave        | Por defecto     | Qué controla                                                  |
| :----------- | :-------------- | :------------------------------------------------------------- |
| `navigation` | dos entradas    | Enlaces de la barra; una entrada con `children` es un desplegable |
...
| `landing`    | distintivo, titular, descripción, una acción, seis características | La página en `/` |

Cuatro se entregan vacíos, por dos razones distintas. `links`, `aside.links` y
`footer.legal` nombran un proyecto concreto — un repositorio, una comunidad, un
aviso legal — y pertenecen a quien gestiona el sitio. `sections` nombra las
...
| `headline`    | una línea de texto          | El `h1`; recae en `title`                             |
| `description` | una línea de texto          | El párrafo bajo él, y la meta descripción de la página |
...
| `features`    | seis                        | La rejilla de tarjetas                                |
...
principal son la llamada; repetirlos bajo seis tarjetas exige a un lector recién
...
| `icon`        | `string`            | Cualquier nombre de Iconify, p. ej. `lucide:github` |
