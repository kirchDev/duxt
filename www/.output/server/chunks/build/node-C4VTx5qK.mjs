import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};//#region ../node_modules/.pnpm/@sqlite.org+sqlite-wasm@3.53.0-build1/node_modules/@sqlite.org/sqlite-wasm/dist/node.mjs
/* @preserve
**
...
async function sqlite3InitModule(moduleArg = {}) {
	...
	var Module = moduleArg;
	{
		...
		/** @suppress{duplicate} */
		var require = createRequire(globalThis._importMeta_.url);
	}
	var thisProgram = "./this.program";
	var _scriptName = globalThis._importMeta_.url;
	var scriptDirectory = "";
	...
	*/
	...
	function findWasmBinary() {
		...
		return new URL("sqlite3.wasm", globalThis._importMeta_.url).href;
	}
	...
	*/
	...
	var FS_fileDataToTypedArray = (data) => {
		if (typeof data == "string") data = intArrayFromString(data);
	...
	*/
	var UTF8ToString = (ptr, maxBytesToRead, ignoreNul) => {
		if (!ptr) return "";
		var end = findStringEnd(HEAPU8, ptr, maxBytesToRead);
...
var sqlite3_node_default = sqlite3InitModule;

export { sqlite3_node_default as default };
//# sourceMappingURL=node-C4VTx5qK.mjs.map
