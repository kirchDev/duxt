...
import type { DuxtContributor } from '../build/git/git-contributors';
import { contributorsOf } from '../build/git/git-contributors';
...
import { normaliseTfplugindocsPage } from '../build/sources/tfplugindocs';
