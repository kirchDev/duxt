...
import {
  DUXT_BRUNO_LAYOUT,
  brunoSectionType
} from '../build/sections/sections-bruno';
import type { DuxtSectionOptions } from '../build/sections/sections-resolve';
import { duxtSectionInput } from '../build/sections/sections-resolve';
