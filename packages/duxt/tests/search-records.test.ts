...
import type { CachedPage } from '../build/content/content-cache';
import type { DuxtResolvedSource } from '../build/sources/sources-resolve';
import { duxtSearchRecords } from '../build/search/search-records';
...
describe('duxtSearchRecords', () => {
  ...
  describe('the public URL', () => {
    ...
    it('routes a source written in a language at the region i18n serves', () => {
      // The shape `apps/www/` actually has, and the one that quietly indexed
