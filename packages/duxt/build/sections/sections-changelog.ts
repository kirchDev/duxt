...
import { frontmatterBlock } from '../content/frontmatter';
import type { DuxtContributor } from '../git/git-contributors';
import {
  contributorsForVersion,
  releaseContributors
} from '../git/git-contributors';
import type {
  DuxtSectionContext,
  DuxtSectionInput,
  DuxtSectionOptions,
...
import { slugify } from '../sources/sources-resolve';
