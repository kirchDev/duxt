...
<template>
  ...
  >
    ...
    >
      ...
      <DuxtCopyButton :copied="copied" class="ms-auto" @click="copy" />
    </div>

    <DuxtCopyButton
      v-else-if="header"
      :copied="copied"
      class="duxt-code-copy absolute top-2 end-2 opacity-0 transition-opacity group-hover:opacity-100 focus-visible:opacity-100"
