...
export default defineAppConfig({
  duxt: {
        ...
        generated: [
          ...
          // the row moves around inside it.
          {
            ...
            versions: [
              {
                version: 'main',
                path: 'apps/www/demo/main.yaml',
                status: 'upcoming'
              },
              { version: 'v3.x', path: 'apps/www/demo/v3.yaml', default: true },
              {
                version: 'v2.x',
                path: 'apps/www/demo/v2.yaml',
                status: 'deprecated'
              },
              { version: 'v1.x', path: 'apps/www/demo/v1.yaml', status: 'eol' }
            ]
          },
          ...
          {
            type: 'changelog',
            path: 'apps/www/demo/CHANGELOG.md',
            label: 'Changelog',
            slug: 'changelog',
            navigation: 'sections',
    ...
    landing: {
       ...
       * LAYER's English messages. A key in a `apps/www/i18n/` file would be printed
...
`
        ...
        },
        {
          ...
          // `apps/www/server/`. A reader presses Send and gets a 201 back.
