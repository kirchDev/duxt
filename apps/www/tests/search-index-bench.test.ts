 ...
 * test can reach.
 *
 * What #33 asked for is a MEASUREMENT over `apps/www/`'s real content, and the
 ...
 * languages and the sizes measured on `apps/www/`.
 *
...
/**
 * A finished build of `apps/www/`, cut to the files search actually reaches for.
 *
...
/** Pagefind 1.5.2 over `apps/www/`'s 11,937 records, as measured for #33. */
const pagefind = {
  coldBytes: 149_919,
  warmBytes: 13_186,
  files: 12_066,
