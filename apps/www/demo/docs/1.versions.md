...
| :---------------------------- | :----------- | :----------------------------------------------------------------- |
| [`main`](~/demo/main/openapi) | `upcoming`   | 3.x plus a streaming endpoint. May still change                    |
| [`v3.x`](~/demo/openapi)      | `current`    | The full document, and the one served without a version segment    |
| [`v2.x`](~/demo/v2.x/openapi) | `deprecated` | Where `shipments` became `consignments` and paging became a cursor |
| [`v1.x`](~/demo/v1.x/openapi) | `eol`        | Switched off. Kept only to be read                                 |
